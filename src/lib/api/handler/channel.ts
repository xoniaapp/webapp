...
export const createChannel = (
  id: string,
  input: ChannelInput,
): Promise<AxiosResponse<Channel>> => request.post(`channels/${id}`, input);
...
export const deleteChannel = (
  channelId: string,
): Promise<AxiosResponse<boolean>> => request.delete(`channels/${channelId}`);

export const getPrivateChannelMembers = (
  channelId: string,
