...
export const AccountBar: React.FC = () => {
  ...
  return (
    <Flex p="10px" pos="absolute" bottom="0" w="240px" bg="accountBar" align="center" justify="space-between">
      ...
      {/* Home */}
      <Link to="/channels/me">
        <Tooltip hasArrow label="Home" placement="top" bg="brandGray.darkest" color="white">
          <IconButton icon={<RiHome2Line />} aria-label="settings" size="sm" fontSize="20px" variant="ghost" />
        </Tooltip>
      </Link>
      {/* Call Icon */}
      <a target="_blank" rel="noopener noreferrer" href="https://meet.jit.si/">
      <Tooltip hasArrow label="Jitsi Meet" placement="top" bg="brandGray.darkest" color="white">
        <IconButton icon={<RiMicFill />} aria-label="settings" size="sm" fontSize="20px" variant="ghost" />
      </Tooltip>
      </a>
      {/* Setting */}
      <Link to="/account">
        <Tooltip hasArrow label="Settings" placement="top" bg="brandGray.darkest" color="white">
